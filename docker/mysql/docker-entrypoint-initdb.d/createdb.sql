...
#
    CREATE DATABASE IF NOT EXISTS `questar_order_management_system` ;
    GRANT ALL ON `questar_order_management_system`.* TO 'questar' ;

    CREATE DATABASE IF NOT EXISTS `questar_order_management_system_test` ;
    GRANT ALL ON `questar_order_management_system_test`.* TO 'questar' ;
#
#
